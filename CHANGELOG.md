...
* 9.4.0
  ...
  - Fix an issue where some python libraries for Python 2.7 are installed on Python 3 when pip command is running on Python 3. Most existing Python dependent nodes such as Raspberry Pi's GPIO node still depend on Python 2.7.
